 ...
 document.write("My favourite phone is " + inp + "<br>" + "Length of string is: " + inp.length);    
...
var inp = prompt("Enter user name");
for(var i = 0; i < inp.length; i++){
    if((inp.charCodeAt(i) >= 33 && inp.charCodeAt(i) <= 47) 
      || (inp.charCodeAt(i) >= 58 && inp.charCodeAt(i) <= 64)) {
        alert("Please enter a valid user name");
        break;
    }
}
